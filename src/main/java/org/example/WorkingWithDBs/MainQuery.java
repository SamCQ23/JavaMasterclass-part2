...
//        String jpql = " SELECT a FROM Artist a WHERE a.artistName LIKE ?1";
    ...
    private static Stream<Tuple> getArtistsNames(EntityManager em,
                                                 String matchedValue) {

        String jpql = " SELECT a.artistId id, a.artistName as name FROM Artist a " +
                "WHERE a.artistName LIKE ?1 OR album.albumName LIKE ?2";
    ...
    private static Stream<Artist> getArtistsSQL(EntityManager em,
                                                String matchedValue) {
