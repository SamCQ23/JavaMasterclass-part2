...
//            System.out.println("New Order = " + newOrder);
    ...
    //video 365 challenge:
    /*
    - write java code that inserts an Order and at least two Order
      details into your database
            - should be done in a transaction
    - use MySQL Workbench to confirm your inserts worked
    - write code that deletes an Order and its order details
    - use MySQL workbench to confirm an Order and its order details
    - use MySQL workbench to confirm order and its line items were
      actually deleted
