...
import org.example.WorkingWithDBs.music.Album;
import org.example.WorkingWithDBs.music.Artist;
import org.example.WorkingWithDBs.music.Song;
//video 380: bonus
/*
- create a second method on SongQuery that uses a CriteriaBuilder
  Query to produce the same results
 */
    ...
    public static void main(String[] args) {
        ...
        try (
            ...
            var bmatches = getMatchedSongsBuilder(em,
                    "%"+word+"%");
            bmatches.forEach(m -> System.out.printf("%-30s %-65s %s%n",
