...
//                        columnValue.toUpperCase());
                try {
                    deleteArtistsAlbum(connection, statement,
    ...
    private static void deleteArtistsAlbum(Connection conn, Statement statement,
...
//            System.out.printf("Deleted %d rows from music.albums%n",
//                    deletedAlbums);
...
//            System.out.printf("DELETED %d rows from music.artists%n",
//                    deletedArtists);
